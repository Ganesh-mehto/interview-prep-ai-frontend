...
const SummaryCard = ({
    colors,role,topicToFocus,experience,questions,description,lastUpdated,onSelect,onDelete
}) => {
  return (
    <div className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover: shadow-xl hover:shadow-gray-100 relative group " onClick={onSelect}>
        <div className="rounded-lg p-4 cursor-pointer relative" style={{background:colors.bgcolor}}>
            <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-white rounded-md flex itemc justify-center mr-4">
                ...
                <div className="flex-grow">
                    <div className='flex justify-between items-start'>
                        <div>
                            ...
                            <p className='text-xs text-medium text-gray-900'>{topicToFocus}
                            </p>
                        </div>
                    </div>
                </div>
