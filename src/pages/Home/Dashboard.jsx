...
const Dashboard = () => {
  ...
  const [openDeleteAlert,setOpenDeleteAlert]=useState({open:false,
    data:null,
  })
    ...
    <DashBoardLayout>
      <div className="container mx-auto pt-4 pb-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-7 pt-1 pb-6 px-4 md:px-0">
          {sessions?.map((data,index)=>(<SummaryCard
          key={data?._id} 
